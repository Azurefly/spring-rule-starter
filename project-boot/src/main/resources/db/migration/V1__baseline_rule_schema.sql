...
ALTER TABLE rule_meta ADD COLUMN IF NOT EXISTS type VARCHAR(50) NOT NULL DEFAULT 'DROOLS';
ALTER TABLE rule_meta ADD COLUMN IF NOT EXISTS content TEXT;
ALTER TABLE rule_meta ADD COLUMN IF NOT EXISTS status VARCHAR(50) NOT NULL DEFAULT 'ENABLED';
...
ALTER TABLE rule_meta ADD COLUMN IF NOT EXISTS last_build_status VARCHAR(50);
...
ALTER TABLE rule_build_history ADD COLUMN IF NOT EXISTS status VARCHAR(50);
