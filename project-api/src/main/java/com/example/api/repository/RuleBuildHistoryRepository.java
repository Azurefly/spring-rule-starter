...
public interface RuleBuildHistoryRepository extends JpaRepository<RuleBuildHistory, Long> {
    ...
    Optional<RuleBuildHistory> findFirstByRuleNameAndVersionAndStatusOrderByBuiltAtDesc(String ruleName, Integer version, String status);
    long deleteByRuleName(String ruleName);
}
